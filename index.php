...
<script src="JS/indexMyBookScript.js"></script>
...
<div class="indexPanel">
    <ul class="nav nav-tabs" id="indexTabs">
        ...
        if (isset($_SESSION['auth'])) {
            echo '<li><a data-toggle="tab" href="#myBooking">My Bookings</a></li>';
        }
        ?>
    ...
    <div class="tab-content">
        ...
        <!-- bootstrap modal for Sabre clients that don't have cityride user (alert instead of booking form, triggered by book button on main table -->
        <div <?php
        if (isset($_SESSION['sabre_guest'])) {
            echo 'id="booking_form"';
        }
        ?> class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="transfer_details">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" >
                                    <h5 class="panel-title text-center">System Notice</h5>
                                </div>
                                <div class="panel-body">
                                    <div style="float: left; margin-left: 10%">
                                        <img src='http://www.bookcityride.co.il/includes/logo.png' /> 
                                    </div>
                                    <div dir="rtl" style="margin-right: 10%">
                                        <p class="dearAgent">
                                            סוכן/ת יקר/ה, </br>
                                            תודה שבחרת להזמין ב- Cityride </br>
                                            להסדרת הרשאה והסכם ניתן לפנות אלינו באמצעות - </br>
                                            דוא"ל: info@cityride.co.il </br>
                                            טלפון: 03-6133800
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-info btn-lg" style="float:left;" data-dismiss="modal">Back</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="myBooking" class="tab-pane fade">
            <div class="search-bar form-inline">
                <label>Search:</label>
                <input type="text" name="search" class="form-control" id="agent_bookings_search" placeholder="Search by ID / Name / A/P">
                <button  class="btn btn-info" id="agent_bookings_searchBtn">
                    Search
                </button> 
            </div>
            </br>
            <div class="arrows" id="agent_bookings_arrows"></div>

            <div class="transfer_table">        
                <table class="table table-hover table-bordered" id="agent_bookings_info"></table>
            </div>

            <div id="view_agent_booking" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h3 class="modal-title" id="agent_booking_head" style="text-align: center"></h3>
                        </div>
                        <div class="modal-body" id="agent_booking_details">
                            Reservation
                        </div>
                    </div>
                </div>
        ...
        <div id="contactUs" class="tab-pane fade">
            <div>
                <div id="contactUsFormDiv">
                    <form method="POST" action="API.php" id="contactUsForm" class="form-horizontal">
                        <div class="form-group">
                            <label for="con_agent_name" class="col-sm-3 control-label" style="text-align: left">Your Name:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="con_agent_name" id="con_agent_name" <?php
                                if (isset($_SESSION['user_det'])) {
                                    echo 'value="' . $_SESSION['user_det']->u_agent_name . '"';
                                }
                                ?>>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="con_agency" class="col-sm-3 control-label" style="text-align: left">Agency:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="con_agency" id="con_agency" <?php
                                if (isset($_SESSION['user_det'])) {
                                    echo 'value="' . $_SESSION['user_det']->u_agency . '"';
                                }
                                ?>>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="con_email" class="col-sm-3 control-label" style="text-align: left">Email Address:</label>
                            <div class="col-sm-9">
                                <input type="email" class="form-control" name="con_email" id="con_email" <?php
                                if (isset($_SESSION['user_det'])) {
                                    echo 'value="' . $_SESSION['user_det']->u_email . '"';
                                }
                                ?>>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="con_phone" class="col-sm-3 control-label" style="text-align: left">Phone Number:</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="con_phone" id="con_phone" <?php
                                if (isset($_SESSION['user_det'])) {
                                    echo 'value="' . $_SESSION['user_det']->u_phone . '"';
                                }
                                ?>>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="con_message" class="col-sm-3 control-label" style="text-align: left">Your Message:</label>
                            <div class="col-sm-9">
                              <!--  <input type="text" class="form-control" rows="5" id="con_message"> -->
                                <textarea class="form-control" name="con_message" id="con_message" rows="5"></textarea>
                            </div>
                        </div>
                ...
                <div id="contactInfo" class="dearAgent" dir="rtl">
                    ניתן לפנות אלינו גם באמצעות - </br>
                    טלפון: 03-6133800 </br>
                    דוא"ל: info@cityride.co.il
                </div>
            </div>
        </div>
